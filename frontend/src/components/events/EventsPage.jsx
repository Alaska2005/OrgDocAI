...
export default function EventsPage() {
  ...
  const [form, setForm] = useState({
    title: '', description: '', date: '', category: 'Technology',
    coordinator: '', tags: '',
  });
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="card px-4 py-3 flex items-center gap-3 flex-wrap">
        <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-xl px-3 py-1.5 w-44 focus-within:border-purple-400 transition-all">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <select className="input" value={form.category}
                      ...
                      {['Technology', 'Science', 'Arts', 'Sports', 'Workshop'].map((c) => (
